      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          <View style={{ backgroundColor: 'white' }}>
            <ResponsiveImage source={{ uri:  'http://npcrimage.netpracharat.com/imagegood/' + this.state.data.headlines }} resizeMode='stretch' style={{ height: hp('30%') }} />
          </View>
          <Text style={styles.header}>
            {this.state.data.goodname}
          </Text>
          <Text style={styles.header2}>
          {this.state.data.province + ' ' + this.state.data.district + ' ' + this.state.data.subdistrict +' '+ this.state.data.village}
        </Text>
          <View>
            <Text style={styles.detail}>{this.state.data.gooddetail} </Text>
          </View>
          {
