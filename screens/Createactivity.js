...
import { Alert, Platform, StyleSheet, Text, View, Picker,PixelRatio, Image, NativeModules,AsyncStorage , ActivityIndicator } from 'react-native';
...
export default class Createnewscm extends Component {
    ...
    _Postproblem = async () => {
        ...
        }else if(this.state.activityname.length == '' && this.state.activitydetail.length == ''){
        ...
        if (response.data.data == 'ok') {
            ...
            Alert.alert(
                ...
                [
                  {text: 'ตกลง', onPress: () =>  this.props.navigation.reset([NavigationActions.navigate({ routeName: 'Activity' })], 0)},
    ...
    render() {
        ...
        return (
            ...
            <View style={styles.container}>
                <Text style={styles.welcome}><Icon name="ios-people" size={40} color='#00802b' />  เพิ่มกิจกรรม</Text>
                ...
                <KeyboardAwareScrollView>
                    ...
                    <View style={styles.setpositionbutton}>
                        <Button
                            ...
                            title='ยืนยัน'
                            onPress={()=>{Alert.alert(
                                'ยืนยันการเพิ่มกิจกรรม','กดยืนยันเพื่อยืนยันการเพิ่มกิจกรรม หรือ ยกเลิกเพื่อแก้ไข',
                                [
