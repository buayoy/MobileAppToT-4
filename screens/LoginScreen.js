...
export default class LoginScreen extends Component {
    ...
    async getProfile() {
        ...
        // get profile
        const response = await axios.get('https://benz54.auth0.com/userinfo', {
            headers: {
    ...
    _Login = async () => {
        ...
        try {
            const response = await axios.post('https://benz54.auth0.com/oauth/token', {
                "grant_type": "password",
                "username": this.state.email,
                "password": this.state.password,
                "audience": "https://benz54.auth0.com/api/v2/",
                "scope": "openid",
                "client_id": "UE8b6woysqOlhfq7RRryNGhMduAke9L5",
            });
