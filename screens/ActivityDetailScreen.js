...
import { Platform, StyleSheet, Text, View, Image, TouchableHighlight, WebView , ScrollView , ActivityIndicator} from 'react-native';
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <ScrollView>
      <ResponsiveImage source={{uri : 'http://npcrimage.netpracharat.com/imageactivity/'+this.state.data.headlines}} resizeMode= 'stretch' style={{  height: hp('30%') }} />
