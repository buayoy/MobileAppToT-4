...
export default class SelectVerifyOrLogin extends Component {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                {/* <Iion name="ios-megaphone" size={40} color='#00802b' /> */}
                ลงชื่อเข้าใช้ หรือ สมัครสมาชิก</Text>
                <View style={styles.lineStylew1} />
                <View style={styles.lineStylew2} />
                <Text style={styles.setpositiontextafterbutton}>โปรดเลือก</Text>
                    ...
                    <TouchableHighlight
                        ...
                        <View >
                            <Icon
                                ...
                                type='ionicon'
                                containerStyle={{ backgroundColor: '#00802b' }}
                                name="ios-person-add" size={sizelogo} color='white' />
                            <Text style={styles.setpositiontextbeforebutton}>
                                สมัครสมาชิก
                            </Text>
                        </View>
